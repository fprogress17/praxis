import type { ScriptType, ScriptVersionRow } from "@/lib/types/script-version";
...
export async function listVideoScriptVersions(videoId: string): Promise<ScriptVersionRow[]> {
...
export async function saveVideoScriptVersion(
  videoId: string,
