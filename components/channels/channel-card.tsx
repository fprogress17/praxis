    ...
    >
      ...
      <div className="border-t border-border bg-paper/80 px-2 py-2 dark:bg-paper-light/20">
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-md border border-border bg-surface px-3 py-2 text-label font-medium text-foreground transition-colors hover:bg-black/4 dark:hover:bg-white/5"
        >
